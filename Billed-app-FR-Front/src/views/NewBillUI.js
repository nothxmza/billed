                ...
                <div class="col-md-6">
                  <div class="col-half">
                    <label for="expense-type" class="bold-label">Type de dépense</label>
                      <select required class="form-control id="expense-type" blue-border" data-testid="expense-type">
                  ...
                  <div class="col-half">
                    ...
                    <input required type="text" class="form-control blue-border" id="expense-name" data-testid="expense-name" placeholder="Vol Paris Londres" />
                  </div>
                  <div class="col-half">
